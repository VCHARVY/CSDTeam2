...
%type <node> LIST FUNCTION FUNCTION_PREFIX DATA_TYPE PARAMLIST PARAM STMTLIST CLASSDEF CLASSBODY CLASSMEMBER ACCESS_MODIFIER STMT DECLARATION ASSIGNMENT EXPR RETURN_STMT UNARY_EXPR PRIMARY_EXPR UNARY_OP CONST IF_STMT ELIF_STMT ELSE_STMT WHILE_STMT FOR_STMT FUNCTION_CALL ARGUMENTLIST ARG FUNCTION_TYPE POSTFIX_EXPR ARR_VALUES
